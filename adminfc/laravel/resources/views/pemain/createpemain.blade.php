            ...
            <form action="{{ Route('pemain.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 form-group">
                    ...
                    <input type="text" class="col-md-1 form-control @error('nomor') is-invalid @endError" id="nomor"
                        name="nomor" required autofocus value="{{ old('nomor') }}" maxlength="3">
                    @error('nomor')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group">
                    ...
                    <select class="col-md-4 form-control @error('posisi') is-invalid @endError" id="posisi"
                        ...
                        @foreach ($posisi as $p)
                            <option value="{{ $p->id }}" {{ old('posisi') == $p->id ? 'selected' : '' }}>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <select class="form-control col-md-4 @error('grup_tim') is-invalid @endError" id="urutan"
                        name="grup_tim">
                        <option value="Primary" {{ old('grup_tim') == 'Primary' ? 'selected' : '' }}>Primary</option>
                        <option value="Secondary" {{ old('grup_tim') == 'Secondary' ? 'selected' : '' }}>Secondary</option>
                    </select>
                    @error('grup_tim')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="date" class="col-md-4 form-control @error('tanggal_lahir') is-invalid @endError"
                        id="title" name="tanggal_lahir" required autofocus value="{{ old('tanggal_lahir') }}">
                    @error('tanggal_lahir')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="text" class="form-control @error('tempat_lahir') is-invalid @endError" id="title"
                        name="tempat_lahir" required autofocus value="{{ old('tempat_lahir') }}">
                    @error('tampat_lahir')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="text" class="form-control @error('negara') is-invalid @endError" id="title"
                        name="negara" required autofocus value="{{ old('negara') }}">
                    @error('negara')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <select class="form-control col-md-2 @error('bermain') is-invalid @endError" id="bermain"
                        name="bermain">
                        @for ($i = 0; $i <= 100; $i++)
                            <option value="{{ $i }}" {{ old('bermain') == $i ? 'selected' : '' }}>
                                {{ $i }}</option>
                        @endfor
                    </select>
                    @error('bermain')
                ...
                <div class="mb-3 form-group ">
                    ...
                    <select class="form-control col-md-2 @error('kartu_kuning') is-invalid @endError" id="kartu_kuning"
                        name="kartu_kuning">
                        @for ($i = 0; $i <= 100; $i++)
                            <option value="{{ $i }}" {{ old('kartu_kuning') == $i ? 'selected' : '' }}>
                                {{ $i }}</option>
                        @endfor
                    </select>
                    @error('kartu_kuning')
                ...
                <div class="mb-3 form-group ">
                    ...
                    <select class="form-control col-md-2 @error('kartu_merah') is-invalid @endError" id="kartu_merah"
                        name="kartu_merah">
                        @for ($i = 0; $i <= 100; $i++)
                            <option value="{{ $i }}" {{ old('kartu_merah') == $i ? 'selected' : '' }}>
                                {{ $i }}</option>
                        @endfor
                    </select>
                    @error('kartu_merah')
                ...
                <div class="mb-3 form-group ">
                    ...
                    <select class="form-control col-md-2 @error('goal') is-invalid @endError" id="goal"
                        name="goal">
                        @for ($i = 0; $i <= 100; $i++)
                            <option value="{{ $i }}" {{ old('goal') == $i ? 'selected' : '' }}>
                                {{ $i }}</option>
                        @endfor
                    </select>
                    @error('goal')
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="date" class="col-md-4 form-control @error('tanggal_masuk') is-invalid @endError"
                        id="title" name="tanggal_masuk" required autofocus value="{{ old('tanggal_masuk') }}">
                    @error('tanggal_masuk')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                {{-- <div class="mb-3 form-group ">
                    ...
                    <input type="date" class="col-md-4 form-control @error('tanggal_keluar') is-invalid @endError"
                        id="title" name="tanggal_keluar" required autofocus value="{{ old('tanggal_masuk') }}">
                ...
                <div class="mb-3 form-group ">
                    ...
                    <Textarea type="text" rows="3" class="form-control @error('informasi_lain') is-invalid @endError"
                        id="informasi_lain" name="informasi_lain">{{ old('informasi_lain') }}</Textarea>
