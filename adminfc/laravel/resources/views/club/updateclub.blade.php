    ...
    <div class="row">
        <div class="col-md-8 my-3">
            <form action="{{ Route('club.update', $club) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="gbr_lama" value="{{ $club->logo }}">
                <div class="mb-3 form-group ">
                    <label for="nama" class="form-label">Nama Club</label>
                    <input type="text" class="form-control @error('nama') is-invalid @endError" id="nama"
                        name="nama" required autofocus value="{{ old('nama', $club->nama) }}">
                    @error('nama')
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="text" class="form-control @error('tempat') is-invalid @endError" id="tempat"
                        name="tempat" required value="{{ old('tempat', $club->tempat) }}">
                    @error('tempat')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="text" class="form-control @error('kontak') is-invalid @endError" id="kontak"
                        name="kontak" value="{{ old('kontak', $club->kontak) }}">
                    @error('kontak')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="text" class="form-control @error('manager') is-invalid @endError" id="manager"
                        name="manager" value="{{ old('manager', $club->manager) }}">
                    @error('manager')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="text" class="form-control @error('pelatih') is-invalid @endError" id="pelatih"
                        name="pelatih" value="{{ old('pelatih', $club->pelatih) }}">
                    @error('pelatih')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <input type="text" class="form-control @error('lapangan') is-invalid @endError" id="lapangan"
                        name="lapangan" value="{{ old('lapangan', $club->lapangan) }}">
                    @error('lapangan')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 form-group ">
                    ...
                    <select class="form-control col-md-4 @error('aktif') is-invalid @endError" id="aktif"
                        name="aktif">
                        <option value="Y" {{ $club->aktif == 'Y' ? ' selected' : '' }}>Ya</option>
                        <option value="T" {{ $club->aktif == 'T' ? ' selected' : '' }}>Tidak</option>
                    </select>
                    @error('aktif')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class=" form-group">
                    ...
                    @if ($club->logo)
                        <img class="img-fluid img-preview col-md-8 mt-3"
                            src="{{ asset('public/images/klub/' . $club->logo) }}">
                    @else
                ...
                <div class="mb-3 form-group ">
                    ...
                    <textarea type="text" rows="3" class="form-control @error('map') is-invalid @endError" id="map"
                        name="map">{{ old('map', $club->map) }}</textarea>
                    @error('map')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
